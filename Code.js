...
1. Add your insertable text in insertableText as a key/value pair. 
2. Add a menu item. 
...
function calculateAcres(){
  ...
  if (response.getSelectedButton() == ui.Button.YES) {
       ...
       ui.alert(Number(response.getResponseText()) + ' tons of pellets is equal to ' + Math.round(Number(response.getResponseText())*0.024) + ' acres per year, or ' + Math.round(Number(response.getResponseText())*0.024/365) + ' acres per day. ');

 //start if NO
     } else if (response.getSelectedButton() == ui.Button.NO) {
       
       ui.alert(Number(response.getResponseText()) + ' tons of pellets is equal to ' + Math.round(Number(response.getResponseText())*0.0265) + ' acres per year, or ' + Math.round(Number(response.getResponseText())*0.0265/365) + ' acres per day. ');       
